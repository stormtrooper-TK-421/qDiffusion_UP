...
then
    ...
    curl -L --progress-bar "https://github.com/astral-sh/python-build-standalone/releases/download/20260303/cpython-3.10.20+20260303-$arch-unknown-linux-gnu-install_only.tar.gz" -o "python.tar.gz"
