...
namespace qDiffusion
{
    class Worker
    {
        ...
        public void Work(string[] args)
        {
            ...
            var app_user_model_id = "stormstrooper_tk_421.qdiffusion." + MD5(exe);
            ...
            if (!Directory.Exists("python"))
            {
                ...
                var python_file = "python-3.10.20.tar.gz";
                var python_url = "https://github.com/astral-sh/python-build-standalone/releases/download/20260303/cpython-3.10.20+20260303-x86_64-pc-windows-msvc-shared-install_only.tar.gz";
            ...
            if (!Directory.Exists("venv\\Lib\\site-packages\\PyQt5"))
            {
                ...
                try
                {
                    Run(python, "-m", "pip", "install", "PyQt5==5.15.11");
                }
                catch (Exception ex)
                {
                    LaunchError(ex.Message);
