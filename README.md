...
--------
Built from the ground up alongside [sd-inference-server](https://github.com/stormstrooper-tk-421/sd-inference-server), the backend for this GUI.
![example](https://github.com/stormstrooper-tk-421/qDiffusion/raw/master/source/screenshot.png)
\*new\* Discord: [Arena Systems](https://discord.gg/WdjKqUGefU).

## Getting started
### Install
1. [Download](https://github.com/stormstrooper-tk-421/qDiffusion/archive/refs/heads/master.zip) this repo as a zip and extract it.
2. Run `qDiffusion.exe` (or `bash ./source/start.sh` on Linux, `sh ./source/start-mac.sh` on Mac).
	...
	- AMD Ubuntu users need to follow: [Install ROCm](https://github.com/stormstrooper-tk-421/qDiffusion/wiki/Install#ubuntu-22).
...
Information is available on the [Wiki](https://github.com/stormstrooper-tk-421/qDiffusion/wiki/Guide).

### Remote
Notebooks for running a remote instance are available: [Colab](https://colab.research.google.com/github/stormstrooper-tk-421/qDiffusion/blob/master/remote_colab.ipynb), [SageMaker](https://studiolab.sagemaker.aws/import/github/stormstrooper-tk-421/qDiffusion/blob/master/remote_sagemaker.ipynb)
...
1. Open the [Colab](https://colab.research.google.com/github/stormstrooper-tk-421/qDiffusion/blob/master/remote_colab.ipynb) notebook. Requires a Google account.
...
6. Done. See [Downloads](https://github.com/stormstrooper-tk-421/qDiffusion/wiki/Guide#downloading) for how to get models onto the instance.
...
### Mobile
[qDiffusion Web](https://github.com/stormstrooper-tk-421/stormstrooper-tk-421.github.io) is available for mobile users. Features are limited compared to the full GUI (txt2img only).
